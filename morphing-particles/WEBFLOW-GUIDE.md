...
```html
<script type="module" src="https://cdn.jsdelivr.net/gh/teresa-getcreativ/claudecode@morphing-particles/morphing-particles/webflow-embed.js"></script>
```

Or if you prefer to self-host, upload `webflow-embed.js` to your Webflow assets.
...
| `data-morph-color1` | Hex color for resting state | Optional (default: `#676A72`) |
| `data-morph-color2` | Hex color for active/morphed | Optional (default: `#4285f4`) |
| `data-morph-color3` | Hex color accent | Optional (default: `#676A72`) |
...
- Mouse leave → particles scatter back
- Each instance only renders when scrolled into view (performance)
- Automatically resizes with the div
